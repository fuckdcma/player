    ...
    var e, t, n = {
        ...
        5083: (e,t,n)=>{
            ...
            const u = {
              ...
              , p = function(e, t) {
                ...
                }(t, "mute") && ("boolean" == typeof t.mute && (f.mute = t.mute),
                delete t.mute);
                const g = Object.assign({}, f, null == (p = window) || null == (h = p.jwplayer) ? void 0 : h.defaults, t, e);
                !function(e) {
                ...
                const m = g.forceLocalizationDefaults ? u.language : (0,
                c.G3)()
                  , y = (0,
                c.tK)(g.intl);
                g.localization = (0,
                ...
                r.a)(v.height),
                v.aspectratio = (0,
                r.R)(v.aspectratio, v.width),
                "string" == typeof v.volume && (v.volume = parseFloat(v.volume)),
                v.volume = (0,
                s.qh)(v.volume) ? Math.min(Math.max(0, v.volume), 100) : u.volume,
                ...
                b && (v.item = b),
                (0,
                s.hj)(v.item) || (v.item = 0);
                const w = g.autoPause;
                w && (v.autoPause.viewability = !("viewability"in w) || Boolean(w.viewability));
                ...
                if (j)
                    ...
                    const e = (0,
                    s.ei)(v, ["title", "description", "type", "mediaid", "image", "images", "file", "sources", "tracks", "preload", "duration", "chapters"]);
                    v.playlist = [e]
                }
                ...
                let C = v.liveTimeout;
                null !== C && ((0,
                s.qh)(C) ? 0 !== C && (C = Math.max(30, C)) : C = null,
                v.liveTimeout = C);
                const P = parseFloat(v.bandwidthEstimate)
                  , O = parseFloat(v.bitrateSelection);
                ...
                s.qh)(O) ? O : u.bitrateSelection,
                v.liveSyncDuration = d(v.liveSyncDuration),
                v.backgroundLoading = (0,
                s.jn)(v.backgroundLoading) ? v.backgroundLoading : a.Features.backgroundLoading,
                v.enableAdLoadingUI = !a.Features.enableAdLoadingUI || Boolean(v.enableAdLoadingUI),
                v
            }
        }
        ,
        ...
        623: (e,t,n)=>{
              ...
              , m = function(e) {
                ...
                return p.OS.tizen ? g() : t && r && i ? function() {
                    const e = n.e(605).then(function(e) {
                        ...
                        return u.v.controls = n(5827).default,
                        (0,
                        c.Z)(n(9181).default),
                        t
                    }
            ...
            Object.assign(te.prototype, {
                ...
                init(e, t) {
                    ...
                    Object.assign(this.mediaShim, H.L4);
                    const s = e
                      , a = (0,
                    i.ZP)(Object.assign({}, e), o);
                    a.id = t.id,
                    a.setupConfig = s,
                    Object.assign(n.attributes, a, H.bv),
                        ...
                        this.setup && function(e, t, n) {
                            Promise.resolve().then((()=>{
                                ...
                                if (!o) {
                                    const t = (0,
                                    G.Z)(e, r);
                                    G.Z.cloneIcon && t.querySelector(".jw-icon").appendChild(G.Z.cloneIcon("error")),
                                    ee(e, t)
                                }
                                i.set("errorEvent", r),
                                i.set("state", y.Vy),
        ...
        4101: (e,t,n)=>{
            ...
            Object.assign(c.prototype, {
                ...
                getNewInstance(e, t, n) {
                    ...
                    return i.addToPlayer = function(e=!1) {
                        const t = this.getContainer().querySelector(".jw-overlays");
                        if (t)
                            return n.left = t.style.left,
                            n.top = t.style.top,
                            t.appendChild(n),
                            e ? this.trigger("pluginInitialized", o) : setTimeout((()=>this.trigger("pluginInitialized", o)), 0),
                            i
                    }
                    ,
        ...
        8518: (e,t,n)=>{
            ...
            const O = (e,t,n,r)=>{
              ...
              , S = (e,t)=>{
                ...
                return O(n, "errors", e, t),
                O(n, "related", e, t),
                O(n, "sharing", e, t),
                O(n, "advertising", e, t),
                O(n, "shortcuts", e, t),
                O(n, "captionsStyles", e, t),
                n
            }
        }
        ,
        ...
        5882: (e,t,n)=>{
            ...
            const b = (e,t,n)=>{
              ...
              , O = e=>!(!Boolean(e.ctrlKey) || "click" !== e.type) || ("which"in e ? 3 === e.which : "button"in e && 2 === e.button)
              , S = (e,t)=>{
                if (v || (v = new I(document).on("interaction")),
              ...
              , E = e=>{
                ...
                x(e, h, (n=>{
                    const {target: r} = n;
                    O(n) || Boolean(e.directSelect) && r !== t || (n.isPrimary && "BUTTON" === r.tagName && r.focus(),
                    e.lastStart = (0,
                    s.z)(),
                    e.clicking = !0)
                }
                ...
                j(e, h, "click", (n=>{
                    O(n) || Boolean(e.directSelect) && n.target !== t || ((0,
        ...
        6042: (e,t,n)=>{
            ...
            const o = {}
              ...
              , E = x
              , T = [];
            x(["Function", "String", "Number", "Date", "RegExp"], (function(e) {
                T[e] = function(t) {
            ...
            const A = T.Date
              ...
              , B = function(e, t, n) {
                const r = [];
                return null == e ? r : h && e.map === h ? e.map(t, n) : (x(e, (function(e, i, o) {
              ...
              , V = function(e, t, n) {
                t || (t = U);
                let r = !1;
                return null == e ? r : v && e.some === v ? e.some(t, n) : (x(e, (function(e, i, s) {
              ...
              , K = function(e, t, n) {
                const r = [];
                return null == e ? r : m && e.filter === m ? e.filter(t, n) : (x(e, (function(e, i, o) {
              ...
              , X = function(e, t, n) {
                t || (t = U);
                let r = !0;
                return null == e ? r : y && e.every === y ? e.every(t, n) : (x(e, (function(e, i, s) {
                    if (!(r = r && t.call(n, e, i, s)))
                        return o
                }
                )),
              ...
              , J = X
              , Y = function(e) {
                return null == e ? 0 : e.length === Number(e.length) ? e.length : S(e).length
            }
              , ee = function(e, t) {
                let n;
                return function(...r) {
            ...
            const te = function(e) {
              ...
              , Te = {
                ...
                matches: he,
                max: function(e, t, n) {
                    if (!t && F(e) && e[0] === Number(e[0]) && e.length < 65535)
                        return Math.max(...e);
                    let r = -1 / 0
                      , i = -1 / 0;
                    return x(e, (function(e, o, s) {
        ...
        6601: (e,t,n)=>{
            ...
            const r = "8.34.1+commercial_master.567.ads-dai@mono.ads-freewheel@mono.ads-googima@mono.ads-vast@mono.hls.js@1.4.10.jwplayer@mono.jwplayer-ads-header-bidding@github:jwplayer/jwplayer-ads-header-bidding#v7.8.0.jwplayer-analytics@github:jwplayer/jwplayer-analytics#v4.0.5.plugin-gapro@mono"
        }
        ,
        4225: (e,t,n)=>{
            "use strict";
        ...
        2445: (e,t,n)=>{
            ...
            var p = n(4737)
              ...
              , f = n(67)
              , g = n(3487);
            const m = e=>"string" == typeof e && /^\/\/(?:content\.jwplatform|cdn\.jwplayer)\.com\//.test(e)
              , y = e=>`https:${e}`
              , v = e=>{
                const t = (0,
                c.Z)(e.edition)
              ...
              , w = e=>{
                ...
                b(t, e.keepWatching, "keepWatching"),
                t
            }
              , k = function(e, t) {
                let c = (0,
                ...
                const p = c.key || a.default.key
                  , g = new l.ZP(p)
                  , b = g.edition();
                if ("free" === g.edition() && (c = Object.assign({
                    skin: {
                        active: "#ff0046",
                        timeslider: {
                            progress: "none"
        ...
        6577: (e,t,n)=>{
            ...
            var p = n(8675)
              ...
              , b = n(328)
              , w = n(3487);
            const k = [["vastxml", "adtag", "schedules"]]
              , j = {
                googima: k,
                vast: k
            }
              , C = (e,t)=>{
                ...
                const i = n.div;
                null != i && i.parentElement && i.parentElement.removeChild(i),
              ...
              , P = (e,t,n,r)=>{
                ...
                if (-1 === o.indexOf(i))
                    throw new Error(`setupDynamicPlugin must be called with plugins with one of the following plugins: ${o.toString()}`);
                C(e, i);
                const a = ((e,t,n)=>{
                    const r = Object.assign({}, e)
                      , i = Object.assign({}, t)
                      , o = Object.keys(i).filter((e=>null === e));
                    return o.forEach((e=>delete r[e])),
                    o.forEach((e=>delete i[e])),
                    n.forEach((e=>{
                        e.some((e=>i[e])) && e.forEach((e=>delete r[e]))
                    }
                    )),
                    Object.assign({}, r, i)
                }
            ...
            function A(e) {
                ...
                Object.assign(this, {
                    ...
                    setupDynamicPlugin(e, t) {
                        return e ? P(this, e, t, o.get("plugins")) : Promise.resolve()
                    },
            ...
            Object.assign(A.prototype, {
                on(e, t, n) {
                    return b.on.call(this, e, t, n)
                },
                once(e, t, n) {
                    return b.IH.call(this, e, t, n)
                },
                off(e, t, n) {
                    return b.S1.call(this, e, t, n)
                },
                trigger(e, t) {
                    return (t = S.ZP.isObject(t) ? Object.assign({}, t) : {}).type = e,
                    f.Z.debug ? b.X$.call(this, e, t) : b.wj.call(this, e, t)
                },
                getPlugin(e) {
            ...
            const Z = e=>{
              ...
              , _ = function(e) {
                let t, n;
                if (e ? "string" == typeof e ? (t = Z(e),
                t || (n = document.getElementById(e))) : "number" == typeof e ? t = s.Z[e] : e.nodeType && (n = e,
                t = Z(n.id || n.getAttribute("data-jwplayer-id"))) : t = s.Z[0],
                t)
                    return t;
                if (n) {
                    const e = new A(n);
            ...
            q.utils.css.style = q.utils.style,
            q.vid = $.Z;
            const z = q;
            var U = n(7543);
            const V = /^(?:on(?:ce)?|off|trigger)$/
              , H = e=>{
              ...
              , X = (e,t,n,r)=>{
                ...
                i.forEach((o=>{
                    const s = n[o];
                    -1 === Q.indexOf(o) && ("function" == typeof s && "Events" !== o ? e[o] = K(e, t, o, i, r) : "_events" === o ? e._events = {} : Object.defineProperty(e, o, {
                        enumerable: !0,
                        get: ()=>n[o]
                    }))
                }
              ...
              , J = function(e) {
                const t = {};
                X(this, e, e, t),
                X(this, e, A.prototype, t)
            }
              , Y = window;
            Object.assign(I, z);
            const ee = function(e) {
                const t = I(e);
                return t.uniqueId ? t._publicApi || (t._publicApi = new J(t)) : t
            };
            Object.assign(ee, z),
            M(ee),
            "function" == typeof Y.define && Y.define.amd && Y.define([], (function() {
                return ee
            }
            ));
            let te = ee;
            Y.jwplayer && (te = Y.jwplayer);
            const ne = te
        }
        ,
        8675: (e,t,n)=>{
        ...
        2963: (e,t,n)=>{
            ...
            const l = e=>{
              ...
              , u = e=>/mpd|dash/.test(((null == e ? void 0 : e.type) || "").toLowerCase()) || ((null == e ? void 0 : e.file) || "").toLowerCase().indexOf("mpd-time-csf") > -1
              ...
              , f = e=>{
                if (e.drm || !c(e))
                    return !1;
                const t = Boolean(null == a.Z || null == a.Z.canPlayType ? void 0 : a.Z.canPlayType("application/vnd.apple.mpegURL"))
                ...
                return !(t && i.Browser.safari && !n) && ((!t || !i.OS.android || !1 === e.androidhls || !1 !== e.hlsjsdefault) && l(e.mediaTypes))
            }
              , g = e=>!(e.drm && !(0,
            s.d3)(e.drm)) && (l(e.mediaTypes) && (u(e) || c(e)));
            d.supports = h,
            r.B.push({
                name: "shaka",
                supports: g
