! function(e, t) {
    ...
    return function(e) {
        ...
        function(e, t, a) {
            ...
            }, s.Cancel = a(13), s.CancelToken = a(55), s.isCancel = a(8), s.all = function(e) {
                return Promise.all(e)
            }, s.spread = a(56), e.exports = s, e.exports.default = s
        },
        function(e, t, a) {
            "use strict";
            var n = a(0),
        ...
        function(e, t, a) {
            ...
            e.exports = function(e) {
                return l(e), e.headers = e.headers || {}, e.data = o(e.data, e.headers, e.transformRequest), e.headers = n.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers), n.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function(t) {
                    delete e.headers[t]
                })), (e.adapter || i.adapter)(e).then((function(t) {
                    return l(e), t.data = o(t.data, t.headers, e.transformResponse), t
                }), (function(t) {
                    return r(t) || (l(e), t && t.response && (t.response.data = o(t.response.data, t.response.headers, e.transformResponse))), Promise.reject(t)
                }))
            }
        },
        function(e, t, a) {
                ...
                return t = e, (a = [{
                    ...
                    value: function(e, t) {
                        ...
                        this.options.apiBackend.send({
                            url: this.options.api.address + "?ac=dm&",
                            data: n,
                            success: t,
                            error: function(e) {
            ...
            var be = function() {
                function e(t) {
                    ...
                    ! function(e, t) {
                        ...
                        a.setAutoHide()
                    }))), this.initPlayButton(), this.initThumbnails(), this.initPlayedBar(), this.initFullButton(), this.initQualityButton(), this.initScreenshotButton(), this.initSubtitleButton(), this.initHighlights(), r.isSafari && this.initAirplayButton(), r.isMobile || this.initVolumeButton()
                }
                var t, a, n;
                return t = e, (a = [{
                    key: "initPlayButton",
            ...
            var Oe = 0,
                ...
                je = function() {
                    function e(t) {
                        ...
                        }), this.comment = new ke(this)), this.setting = new we(this), this.plugins = {}, document.addEventListener("click", (function() {
                            a.focus = !1
                        }), !0), this.container.addEventListener("click", (function() {
                            a.focus = !0
                        }), !0), this.paused = !0, this.timer = new ue(this), this.hotkey = new Se(this), this.contextmenu = new Le(this), this.initVideo(this.video, this.quality && this.quality.type || this.options.video.type), this.infoPanel = new qe(this), !this.danmaku && this.options.autoplay && this.play(), Oe++, Pe.push(this)
                    }
                    var t, a, o;
                    return t = e, o = [{
                        key: "version",
                        ...
                        key: "seek",
                        value: function(e) {
                            e = Math.max(e, 0), this.video.duration && (e = Math.min(e, this.video.duration)), this.video.currentTime < e ? this.notice("".concat(this.tran("FF"), " ").concat((e - this.video.currentTime).toFixed(0), " ").concat(this.tran("s"))) : this.video.currentTime > e && this.notice("".concat(this.tran("REW"), " ").concat((this.video.currentTime - e).toFixed(0), " ").concat(this.tran("s"))), this.video.currentTime = e, this.danmaku && this.danmaku.seek(), this.bar.set("played", e / this.video.duration, "width"), this.template.ptime.innerHTML = r.secondToTime(e)
                        }
                    }, {
                        key: "play",
                        value: function(e) {
                                ...
                                case "flv":
                                    if (window.flvjs)
                                        if (window.flvjs.isSupported()) {
                                            ...
                                            this.plugins.flvjs = r, r.attachMediaElement(e), r.load(), this.events.on("destroy", (function() {
                        ...
                        key: "destroy",
                        value: function() {
                            Pe.splice(Pe.indexOf(this), 1), this.pause(), this.controller.destroy(), this.timer.destroy(), this.video.src = "", this.container.innerHTML = "", this.events.trigger("destroy")
                        }
                    }]) && Ae(t.prototype, a), o && Ae(t, o), e
                }();
            console.log("\n".concat(" %c DPlayer v", "1.26.0", " ").concat("63275c8", " %c http://dplayer.js.org ", "\n", "\n"), "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
            console.log("\n".concat(" %c 量子资源网 ",  " ").concat( " %c https://www.liangzizy.com ", "\n", "\n"), "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
            t.default = je
        }
    ]).default
}));
